const mockUsers = [
  {
    ...
    upcomingShifts: [
      { id: 1, title: 'Meal Delivery', date: '2026-03-20', time: '10:00 AM – 12:00 PM', location: 'Sunnybrook LTC, 2075 Bayview Ave' },
      { id: 2, title: 'Social Activity Support', date: '2026-03-25', time: '2:00 PM – 4:00 PM', location: 'Shepherd Village, 3760 Sheppard Ave E' },
      { id: 3, title: 'Recreational Program', date: '2026-04-02', time: '1:00 PM – 3:00 PM', location: 'Extendicare Bayview, 45 Overlea Blvd' },
    ],
    volunteerHistory: [
  ...
  },
  {
    ...
    password: 'password123',
    role: 'organization',
    orgName: 'Sunrise Care Foundation',
    isApproved: true,
    upcomingShifts: [],
    volunteerHistory: [],
  },
